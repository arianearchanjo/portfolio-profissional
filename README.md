...
- **Cursor personalizado:** Cursor + follower animado com efeito hover em elementos interativos.
- **100% Responsivo:** Menu hamburguer, layouts adaptados para mobile e tablet.

## 🛠️ Tecnologias
- HTML5 Semântico
- CSS3 (Vanilla) com Custom Properties, Flexbox e Grid
...
## 🚀 Como usar
Basta abrir o `index.html` em qualquer navegador ou hospedar em Vercel, Netlify ou GitHub Pages.

---
*Design & Código por Ariane Archanjo · ariarch.dev · 2026*
